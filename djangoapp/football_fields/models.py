...
class FootballField(models.Model):
    ...
    grass_type = models.CharField(max_length=3, choices=GRASS_CHOICES, default='')
    has_field_lighting = models.BooleanField(blank=False, default=False)
    has_changing_room = models.BooleanField(blank=False, default=False)
