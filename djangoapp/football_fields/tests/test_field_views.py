...
class TestFootballFieldViews:
    ...
    def address_fixture(self, football_field_fixture):
        yield Address.objects.create(
            ...
            district="Itaipuaçu",
            cep_code="24999-392",
            latitude=Decimal("-12.42"),
            longitude=Decimal("-12.42"),
        )

    @pytest.fixture
    def user_fixture(self):
        yield User.objects.create_user(
            email="test_views@views.com", password="abc123", is_staff=True
        )
    ...
    def test_detail_if_field_exists(
        self, client: Client, logged, football_field_fixture
    ):
