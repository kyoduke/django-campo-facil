...
class Reservation(models.Model):
    ...
    football_field = models.ForeignKey(
        FootballField, on_delete=models.CASCADE, related_name="reservations"
    )
    ...
    def clean(self):
        if (
            ...
            and isinstance(self.reservation_day, datetime.date)
        ):
...
class BlockedTimeSlot(models.Model):
    football_field = models.ForeignKey(
        FootballField, on_delete=models.CASCADE, related_name="blocked_slots"
    )
